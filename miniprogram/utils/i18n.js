const zh = {
  ...
  idxAuthLoading: "权限核验中...",
   ...
   fuNote: "沟通详情",
   fuNotePlaceholder: "（防止下次忘记）详细记录通话详情...",
   fuUpload: "上传截图",
   fuSubmit: "保存记录",
   fuSuccess: "保存成功",
   // --- 🎯 客户画像模块 (中文) ---
...
'Busy': 'ไม่สะดวกรับสาย',
  ...
  fuNote: "รายละเอียดการติดต่อสื่อสาร",
  fuNotePlaceholder: "（เพื่อป้องกันการลืมในครั้งถัดไป）บันทึกรายละเอียดการสนทนาทางโทรศัพท์อย่างละเอียด...",
  fuUpload: "อัปโหลดภาพ",
